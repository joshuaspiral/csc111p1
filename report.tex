...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Reasons: Required extending the \texttt{Location} entity with locking and item requirements, and modifying \texttt{_handle_go} to prevent unauthorized movement.
        \item Code involved: \texttt{adventure.py} (\texttt{_handle_go}), \texttt{game_entities.py} (\texttt{Location}, \texttt{Item}).
        \item Demo: \texttt{simple_enhancement_demo} in \texttt{simulation.py}.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Code involved: \texttt{adventure.py} (\texttt{_handle_buy}), \texttt{game_data.json} (\texttt{required_items}).
    ...
    \begin{itemize}
        ...
        \item Code involved: \texttt{adventure.py} (\texttt{_handle_read}), \texttt{game_entities.py} (\texttt{Map}).
    ...
    \begin{itemize}
        ...
        \item Code involved: \texttt{adventure.py} (\texttt{_handle_help}).
